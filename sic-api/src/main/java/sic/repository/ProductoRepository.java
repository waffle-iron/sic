...
public interface ProductoRepository extends PagingAndSortingRepository<Producto, Long>,
    ...
    @Query("SELECT p FROM Producto p WHERE p.id_Producto = :idProducto AND p.eliminado = :eliminado")
    Producto findOne(@Param("idProducto") long idProducto, @Param("eliminado") boolean eliminado);
