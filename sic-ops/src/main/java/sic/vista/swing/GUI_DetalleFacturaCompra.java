...
public class GUI_DetalleFacturaCompra extends JDialog {
    ...
    private void setIcon() {
        ImageIcon iconoVentana = new ImageIcon(GUI_DetalleFacturaCompra.class.getResource("/sic/icons/SIC_24_square.png"));
...
//        facturaCompra.setId_Factura(0);
    ...
    private void btn_BuscarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarProductoActionPerformed
        GUI_BuscarProductos gui_buscarProducto = new GUI_BuscarProductos(
                this, true, renglones, 
