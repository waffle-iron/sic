...
public class GUI_DetalleMedida extends JDialog {
    ...
    private static final Logger LOGGER = Logger.getLogger(GUI_DetalleMedida.class.getPackage().getName());
    ...
    private void setIcon() {
        ImageIcon iconoVentana = new ImageIcon(GUI_DetalleCliente.class.getResource("/sic/icons/Ruler_16x16.png"));
