...
public class GUI_PuntoDeVenta extends JDialog {
    ...
    private void buscarProductoConVentanaAuxiliar() {
        if (cantidadMaximaRenglones > renglones.size()) {
            ...
            GUI_BuscarProductos GUI_buscarProductos = new GUI_BuscarProductos(this, true, renglones, cmb_TipoComprobante.getSelectedItem().toString(), movimiento);
    ...
    private void btn_BuscarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarClienteActionPerformed
        GUI_BuscarClientes gui_buscarClientes = new GUI_BuscarClientes(this, true);
            ...
            try {
                if (!cmb_TipoComprobante.getSelectedItem().toString().equals("Pedido")) {
                    ...
                    if (productosFaltantes.isEmpty()) {
                        ...
                        GUI_ProductosFaltantes gui_ProductosFaltantes = new GUI_ProductosFaltantes(productosFaltantes);
