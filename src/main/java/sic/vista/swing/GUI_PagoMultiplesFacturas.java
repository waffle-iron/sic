...
public class GUI_PagoMultiplesFacturas extends javax.swing.JDialog {
    ...
    private void setColumnasTabla() {
        ...
        encabezados[0] = "Tipo";
        encabezados[1] = "Nº Factura";
        encabezados[2] = "Total";
        encabezados[3] = "Total Adeudado";
        ...
        tbl_InformacionFacturas.getColumnModel().getColumn(0).setPreferredWidth(60);
        tbl_InformacionFacturas.getColumnModel().getColumn(1).setPreferredWidth(150);
    ...
    private void cargarRenglones() {
        ...
        if (movimiento == Movimiento.VENTA) {
            for (FacturaVenta factura : facturasVenta) {
                ...
                fila[1] = factura.getNumSerie() + " - " + factura.getNumFactura();
                fila[2] = factura.getTotal();
