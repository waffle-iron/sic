        ...
        panel2Layout.setHorizontalGroup(
            ...
            .addGroup(panel2Layout.createSequentialGroup()
                ...
                .addGroup(panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lbl_Pais, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE))
...
private void btn_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ActualizarActionPerformed
    try {
        if (provinciaSeleccionada == null) {
            ...
            provinciaService.actualizar(provinciaModificada);
            txt_Nombre.setText("");
...
private void cmb_PaisesBusquedaItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmb_PaisesBusquedaItemStateChanged
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            cargarComboBoxPaises(cmb_Paises, modeloComboPaises);
