...
CREATE TABLE `caja` (
  ...
  PRIMARY KEY (`id_Caja`),
  KEY `FK2E7A153BC38053` (`id_UsuarioCierra`),
  KEY `FK2E7A1519D322D1` (`id_Usuario`),
  KEY `FK2E7A156813BD87` (`id_Empresa`),
...
CREATE TABLE `gasto` (
  ...
  KEY `FK5D94B1419D322D1` (`id_Usuario`),
  KEY `FK5D94B146813BD87` (`id_Empresa`),
  KEY `FK5D94B14C25D6C23` (`id_FormaDePago`),
...
) ENGINE=InnoDB AUTO_INCREMENT=3108 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
