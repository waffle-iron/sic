...
public class FormaDePagoTest {
    ...
    private static final String msjUnicoResultado = "Debe existir solo un resultado para la consulta.";
    ...
    @Test
    public void ejecutarConsultaBuscarTodas() {
        tx.begin();
    ...
    @Test
    public void ejecutarConsultaBuscarPredeterminada() {
        tx.begin();
        FormaDePago formaDePago = this.crearUnaFormaDePago();
        em.persist(formaDePago);
        tx.commit();
